/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts -c wrangler.toml -c ../arpamail-relay/wrangler.toml` (hash: c715f88654864d3eeb7d0d982ef5b879)
// Runtime types generated with workerd@1.20260212.0 2026-02-06 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ALIAS_MANAGER: Service<typeof import("../../arpamail-relay/src/index").AliasManager>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SECRET_KEY" | "PUBLIC_TURNSTILE_SITE_KEY">> {}
}
